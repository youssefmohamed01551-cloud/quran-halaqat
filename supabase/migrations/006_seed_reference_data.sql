insert into public.quran_surahs (number, name_ar, name_en, ayah_count) values
...
insert into public.badges (organization_id, code, name_ar, name_en, description_ar, description_en, icon_name, points_required, is_system)
values
  (null, 'first_record', 'البداية المباركة', 'Blessed Start', 'أول سجل حفظ للطالب.', 'First memorization record.', 'auto_awesome', 10, true),
  (null, 'attendance_star', 'نجم الحضور', 'Attendance Star', 'حضور متميز خلال الأسبوع.', 'Excellent weekly attendance.', 'event_available', 50, true),
  (null, 'review_master', 'متقن المراجعة', 'Review Master', 'إتقان مرتفع في المراجعة.', 'High review mastery.', 'workspace_premium', 100, true),
  (null, 'manners', 'حسن الخلق', 'Noble Character', 'تميز في السلوك والأدب.', 'Excellent manners and behavior.', 'favorite', 100, true)
